 ...
 * @param loanwordSources          <p>See {@link LoanwordSourceDto}</p>
 ...
 * @param glosses                  <p>See {@link GlossDto}</p>
 */
@Jacksonized
@Builder
...
public record SenseDto(
        ...
        public static class SenseDtoBuilder {
                private Set<String> limitedToKanji = new HashSet<>();
                private Set<String> limitedToReadings = new HashSet<>();
                private Set<String> partOfSpeech = new HashSet<>();
                private Set<String> crossReferences = new HashSet<>();
                private Set<String> antonyms = new HashSet<>();
                private Set<String> fieldsOfApplication = new HashSet<>();
                private Set<String> miscellaneousInformation = new HashSet<>();
                private Set<String> senseInformation = new HashSet<>();
                private Set<LoanwordSourceDto> loanwordSources = new HashSet<>();
                private Set<String> dialects = new HashSet<>();
                private Set<GlossDto> glosses = new HashSet<>();
        }
}
