 ...
 * <p>The element (if any) is the source word or phrase.</p>
 *
...
public record JMDictLoanwordSourceDto(
    ...
    public static class JMDictLoanwordSourceDtoBuilder {
        JMDictLoanwordSourceDtoBuilder() {
            this.languageCode = "eng";
            this.semanticCoverage = "full";
            this.isConstructedFromSourceLanguageWord = false;
        }
    }
}
